...
<div class="home-brand">
  ...
  {% endif %}
  <h1>Seminar (Dr. Gonçalves): Die Identit??tsrolle in der politischen Kommunikation</h1>
</div>
...
<div class="card-grid">
  <div class="card">
    <h3><a href="{{ '/schedule' | relative_url }}">📅 Zeitplan</a></h3>
    <p>Siehe wöchentliche Themen und Präsentierende</p>
  </div>

  <div class="card">
    <h3><a href="{{ '/instructions' | relative_url }}">📝 Anweisungen</a></h3>
    <p>Richtlinien für Präsentationen und Teilnahme</p>
  </div>

  <div class="card">
    <h3><a href="{{ '/readings/core' | relative_url }}">📚 Literatur</a></h3>
    <p>Zentrale Literatur für das Seminar</p>
  </div>
</div>
